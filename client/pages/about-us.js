          ...
          <div className={Style.aboutus_box}>
            <div className={Style.aboutus_box_hero}>
              <div className={Style.aboutus_box_hero_left}>
                <h1>👋 About Us.</h1>
                <p>
                  Welcome to GlamChain, where innovation meets haute couture in
                  the digital realm.
                  <br></br>
                  At GlamChain, we're redefining the fashion industry by
                  introducing a revolutionary concept: NFT fashion. As pioneers
                  in this space, we've created a platform that merges the
                  timeless elegance of fashion with the cutting-edge technology
            ...
            <div className={Style.aboutus_box_title}>
              ...
              <p>
                Our mission is simple: to empower fashion enthusiasts,
                designers, and collectors alike by providing a unique and
                immersive marketplace for buying, selling, and trading digital
                fashion assets.
                <br></br>
                What sets us apart is our commitment to authenticity,
                creativity, and inclusivity. We collaborate with emerging and
                established designers from around the globe to curate a diverse
                collection of NFT fashion pieces that cater to every style and
                taste.
              </p>
            </div>
            ...
            <div className={Style.aboutus_box_founder}>
              <div className={Style.aboutus_box_title}>
                <h2>💥 Our Team</h2>
                <p>
                  GlamChain24 was founded by a passionate team of individuals
                  who share a deep love for fashion, technology, and blockchain.
                  Our diverse team brings together a wealth of experience and
                  expertise from various fields, including fashion design,
            ...
            <div className={Style.aboutus_box_title}>
              ...
              <p>
                Whether you're a trendsetter looking to acquire the latest
                digital fashion statement, an aspiring designer eager to
                showcase your talent, or a collector seeking rare and exclusive
                pieces, GlamChain is your ultimate destination.
                <br></br>
                Join us on this journey as we revolutionize the fashion industry
                one pixel at a time. Discover the future of fashion with
                GlamChain today.
                <br></br>
                Welcome to the intersection of fashion and technology. Welcome
                to GlamChain!
              </p>
            </div>
